...
// Creating the widget 
class JIPrograms_widget extends WP_Widget
{
...
// Widget name will appear in UI
                __('JI Programs Widget', 'jiprograms_widget_domain'),
// Widget description
                array('description' => __('Widget for programs', 'jiprograms_widget_domain'),)
        );
    }
...
// This is where you run the code and display the output
        echo __('Hello, World!', 'jiprograms_widget_domain');
...
// Widget Backend 
    public function form($instance)
    {
        ...
        {
            $title = __('New title', 'jiprograms_widget_domain');
        }
// Widget admin form
?>
        <p>
...
{
    register_widget('jiprograms_widget');
}
