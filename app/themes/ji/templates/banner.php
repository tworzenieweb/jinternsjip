                        ...
                        <li data-background="<?php echo $url[0] ?>">
                            <div class="start_anime">
                                ...
                                <div class="box_area_slider">
                                    ...
                                    <iframe wmode="Opaque" enablejsapi="1" data-id="<?php echo get_post_meta($post->ID, "_youtube", true); ?>" id="player_<?php echo $post->ID; ?>" style="width:100%; height:100%; position: absolute; top:0; left:0; z-index: 9999999; display: none;" class="youtube" type="text/html" src="<?php echo $src; ?>"></iframe>
                                </div>
